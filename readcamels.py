...
rootdir = '/work2/02248/alexsund/maverick2/nwm'
...
def genLSTMDataSets(forcingType, latentType, splitratio=(0.8,0.2), seq=60, addStatics=False):
    ...
    dir_path = os.path.dirname(os.path.realpath(__file__))
    if addStatics:
        datafile = os.path.join(dir_path, f'processed/camels_lstmlist_{forcingType}_{latentType}_seq{seq}_static_new.pkl')
    else:
        datafile = os.path.join(dir_path, f'processed/camels_lstmlist_{forcingType}_seq{seq}_new.pkl')
